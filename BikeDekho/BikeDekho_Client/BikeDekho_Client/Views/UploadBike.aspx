...
<body>
    <form id="form1" runat="server" class="form-basic">
        <div>
            <h1 style="align-content:center;margin-left:830px;">UPLOAD BIKE</h1>
                        <br/>            <br/>
            <table class="auto-style1">
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Home"  CssClass="button b1"/>
                    </td>
                    <td>
                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="My Bikes" CssClass="button b1" />
                    </td>
                    <td>
                        <asp:Button ID="Button3" runat="server" Text="Upload Bike" Enabled="False" CssClass="button b1"/>
                    </td>
                    <td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Sell" CssClass="button b1" />
                    </td>
                </tr>
            </table>
        </div>
